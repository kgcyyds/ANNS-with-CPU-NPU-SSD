...
DefineBasicParameter(m_postingListIndex, std::string, std::string("SPTAGPostingList.bin"), "PostingListIndex")
DefineBasicParameter(m_fusionIndex, std::string, std::string("SPTAGFusionIndex.bin"), "FusionIndex")
...
DefineBasicParameter(m_quantizerPQFilePath, std::string, std::string(), "QuantizerPQFilePath")
DefineBasicParameter(m_quantizerVectorFilePath, std::string, std::string(), "QuantizerVectorFilePath")
DefineBasicParameter(m_postinglistMemoryFilePath, std::string, std::string(), "PostinglistMemoryFilePath")
...
DefineSSDParameter(m_resultNum, int, 20, "ResultNum")
...
DefineSSDParameter(m_rerank, int, 5, "Rerank")
DefineSSDParameter(m_rerank_batchSize, int, 20, "BatchSize")
DefineSSDParameter(m_changeThreshold, float, 0, "ChangeThreshold")
...
DefineSSDParameter(m_readRatio, float, 0, "ReadRatio")
DefineSSDParameter(m_enableGPU, bool, true, "EnableGPU")
DefineSSDParameter(m_enableReorderIndex, bool, true, "EnableReorderIndex")
DefineSSDParameter(m_rerank_batch, bool, false, "EnableBatch")
DefineSSDParameter(m_enableCalRecall, bool, true, "EnableCalRecall")
DefineSSDParameter(m_testCPUPQ, bool, false, "TestCPUPQ")
