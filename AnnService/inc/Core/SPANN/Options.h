...
namespace SPTAG {
    namespace SPANN {
        ...
        public:
            ...
            std::string m_postingListIndex;
            std::string m_fusionIndex;
            bool m_deleteHeadVectors;
            int m_ssdIndexFileNum;
            std::string m_quantizerFilePath;
            std::string m_quantizerPQFilePath;
            std::string m_quantizerVectorFilePath;
            std::string m_postinglistMemoryFilePath;
            ...
            float m_readRatio;
            bool m_enableGPU;
            bool m_enableReorderIndex;
            bool m_rerank_batch;
            bool m_enableCalRecall;
            bool m_testCPUPQ;
