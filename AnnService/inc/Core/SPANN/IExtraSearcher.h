...
namespace SPTAG {
    namespace SPANN {
        ...
        struct SearchStats
        {
            ...
            //rerank延迟
            double rerankLatency;

            //剪枝延迟
            double cutTreeLatency;

            //向量延迟
            double vectorLatency0;
            ...
            //查表延迟
            double findTableLatency;

            //添加点延迟
            double addPointLatency;
        ...
        public:
            ...
            virtual bool BuildIndexFusion(std::shared_ptr<Helper::VectorSetReader>& p_reader, 
                std::shared_ptr<VectorIndex> p_index, 
                Options& p_opt) = 0;
