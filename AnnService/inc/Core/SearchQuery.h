...
public:
    ...
    inline void Init(const void* p_target, int p_resultNum, bool p_withMeta)
    {
        ...
        m_heapResults = Array<BasicResult>::Alloc(p_resultNum);
    }
    ...
    inline BasicResult* GetHeapResults() const
    {
        return m_heapResults.Data();
    }
...
protected:
    ...
    Array<BasicResult> m_heapResults;

    std::unordered_set<int> initialTopKIDs;
